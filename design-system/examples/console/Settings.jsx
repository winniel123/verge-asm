        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          {checksOn ? (
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <pre style={{ margin: 0, padding: "12px 14px", background: "var(--surface-console)", borderRadius: 12, font: "400 12px/1.7 var(--font-mono)", color: "var(--text-on-console)", overflowX: "auto" }}>{"# on the host — verge cannot rewrite its own image\ndocker compose pull\ndocker compose up -d web worker\ndocker compose exec web verge migrate status"}</pre>
            </div>
          ) : (
