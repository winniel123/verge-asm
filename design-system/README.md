...
**Version 3.24.2** · exported 2026-08-28 · see VERSION.md for the log. The version bumps on every export; when replacing design-system/ wholesale, this number is what landed.
