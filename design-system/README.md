...
**Version 3.2.2** · exported 2026-08-24 · see VERSION.md for the log. The version bumps on every export; when replacing design-system/ wholesale, this number is what landed.
