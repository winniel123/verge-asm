...
// parameter change, having bumped wildcarddiscrim.Version, and commit the result.
...
// a cell outside the enumeration. A missing cell fails the build, naming it. The
// count is 19 (golden-corpus.md §8.4): W1–W6's 17 plus W7's 2.
