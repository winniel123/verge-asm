...
- **The cross-class guard is inert on a one-class install.** A cross-class composition over one class
  ...
  Handed on as a ticket rather than decided here. **Resolved by
  [#169](https://github.com/winniel123/verge-asm/issues/169): accepted, not fixed** — see the rider on
  ADR-0020.
