...
| `design-system/examples/console/` | The `ConsoleApp.jsx` shell, `SignalData.jsx` fixtures, and 24 screen and section components — the shell routes 19 screens. `README.md` there enumerates them |
