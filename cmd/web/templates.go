...
<div class="row">
<nav class="nav"><a href="/">Home</a><a href="/subjects">Subjects</a><a href="/signals">Signals</a><a href="/seeds">Seeds</a><a href="/coverage">Coverage</a>{{if .IsAdmin}}<a href="/settings">Settings</a>{{end}}</nav>
