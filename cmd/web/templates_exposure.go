...
<section class="excard exstat"><span class="microlabel">Exposed to internet</span><span class="num">{{.Exposed}}</span><span class="muted" style="font-size:11.5px">services &#183; both legs concluded</span></section>
